...
cd /scratch/ezorzi/vllm_dir && uv run vllm serve Qwen/Qwen3-30B-A3B-Instruct-2507 --attention-backend FLASH_ATTN --max-model-len 1K --gpu-memory-utilization 0.28 --quantization bitsandbytes &
sleep 60 &&
